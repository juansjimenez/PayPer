...
interface UseTipJournalistParams {
...
* Tips a journalist
*/
const useTipJournalist = ({
  journalistId,
  tipAmount,
  message,
}: UseTipJournalistParams): UseWriteTransactionResponse => {
  const {
    config,
    error: prepareError,
...
export default useTipJournalist;
